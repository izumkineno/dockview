...
// For dock components
<DockviewReactComponent theme={themeAbyss} />

// For other components (splitview, gridview, paneview)
...
```html
<!-- For dock components -->
<dockview-vue :theme="themeAbyss" />

<!-- For other components (splitview, gridview, paneview) -->
<splitview-vue :class="themeAbyss.className" />
```
</FrameworkSpecific>
...
```html
<!-- For dock components -->
<dv-dockview [theme]="themeAbyss"></dv-dockview>

<!-- For other components (splitview, gridview, paneview) -->
<dv-splitview [class]="themeAbyss.className"></dv-splitview>
```
</FrameworkSpecific>

<FrameworkSpecific framework='JavaScript'>
```ts
import { themeAbyss, createDockview } from "dockview-core";
