...
| Mode | Behavior |
|------|----------|
| `'swap'` (default) | Tabs swap positions instantly on drop — the original behavior. |
| `'slide'` | Tabs slide smoothly to open a gap for the dragged tab, similar to browser tabs. |
