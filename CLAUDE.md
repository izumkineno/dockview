...
## Active Technologies
- TypeScript 5.x (strict mode) + None (dockview-core is zero-dependency; framework wrappers are thin layers) (001-tab-drag-animation)
- N/A (purely visual feature, no state persistence changes) (001-tab-drag-animation)

## Recent Changes
- 001-tab-drag-animation: Added TypeScript 5.x (strict mode) + None (dockview-core is zero-dependency; framework wrappers are thin layers)
